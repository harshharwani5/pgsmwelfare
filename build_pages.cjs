...
const unifiedFooterHtml = `
    ...
    <!-- Google Translate Hidden Container & Frame Suppression Styles -->
    ...
    <!-- Google Translate API Callback & Loader -->
    <script>
    ...
    <!-- Universal Navigation & Language Switcher Script -->
    <script>
        ...
        function setLanguage(lang) {
            localStorage.setItem('pgsm_selected_lang', lang);
        ...
        function toggleLanguage() {
            const current = localStorage.getItem('pgsm_selected_lang') || (document.cookie.includes('/en/hi') ? 'hi' : 'en');
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const isHindiCookie = document.cookie.includes('googtrans=/en/hi');
            const savedLang = localStorage.getItem('pgsm_selected_lang') || (isHindiCookie ? 'hi' : 'en');
